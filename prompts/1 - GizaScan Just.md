# 1 — GizaScan: Legal & Justice Audit
I don't want you to describe everything you are processing or the reports, and the final result, the updated file.

You will receive the complete code of **"GizaScan"**: a standalone 3D app (single HTML, ~130 KB, ~1200 lines). Three.js r128, Web Audio, 7 scientific overlays, 16 SCI entries with 100+ claims across 35 depth levels, freemium paywall (R$9.99/$1.99/€1.99), Capacitor IAP.
...
- COPPA/GDPR/LGPD: verify zero data collection (no localStorage, cookies, analytics, tracking)
...
- GDPR Article 13/14 compliance: no personal data = no obligation, but verify
